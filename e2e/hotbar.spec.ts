...
test('edits a flex slot and reaches export', async ({ page }) => {
  ...
  await page.screenshot({ path: 'artifacts/hotbar-lab-plan.png', fullPage: true })
  ...
  await page.screenshot({ path: 'artifacts/hotbar-lab-practice.png', fullPage: true })
  ...
  await page.locator('input[type="file"]').setInputFiles('/mnt/c/Users/minni/AppData/Roaming/PrismLauncher/instances/1.16.1 fsg/minecraft/config/mcsr/standardsettings.json')
  ...
  await page.screenshot({ path: 'artifacts/hotbar-lab-export.png', fullPage: true })
  ...
  await page.screenshot({ path: 'artifacts/hotbar-lab-tablet.png', fullPage: false })
})
