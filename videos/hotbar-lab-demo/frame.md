...
colors:
  ...
  text-muted: "#989F94"
  text-light: "#989F94"
  accent-light: "rgba(165, 199, 107, 0.08)"
  accent-medium: "rgba(165, 199, 107, 0.15)"
  border: "rgba(165, 199, 107, 0.2)"
  card-bg: "rgba(165, 199, 107, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  tag:     { fontFamily: "Inter", px: 12, weight: 600, color: "primary" }
  counter: { fontFamily: "Inter", px: 13, weight: 600, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Inter, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Inter", cqw: 1.25, weight: 600, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Inter", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Inter", cqw: 2.4, weight: 600, lineHeight: 1.35, color: "text" }
...
- **Weights** — the brand font ships `{400, 600, 650, 690, 700, 750, 800, 900}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
